    ...
    <div className='flex flex-col mx-1 lg:mx-[30%] 2xl:mx-[34%]'>
      ...
      <div className='flex flex-row justify-center gap-4 lg:gap-10 mt-4'>
        ...
        >
          <div>
            <img
              className='w-[45%] lg:w-[53%] mt-[14%] lg:mt-[10%] ml-[20%] lg:ml-[15%]'
              src='/bcond2.webp'
              alt='newElevator'
            />

            <p className='text-[35px] font-bold text-right mr-3 mt-0 lg:mt-6 leading-[35px]'>
              nový výťah
            </p>
          </div>
        </div>
      ...
      <div className='flex flex-row justify-center gap-4 lg:gap-10 mt-4'>
        ...
        >
          <div>
            <img
              className='w-[43%] mt-[20%] lg:mt-[15%] ml-[12%]'
              src='/bcond3.webp'
              alt='newWindows'
            />

            <p className='font-bold text-[35px] text-right mt-2 lg:mt-12 mr-3 leading-[35px]'>
              nové okná
            </p>
          </div>
        </div>
        ...
        >
          <div>
            ...
            <p className='text-[35px] font-bold text-right mr-3 -mt-4 lg:mt-2 2xl:mt-10 leading-[35px]'>
              nové stupačky
            </p>
          </div>
        </div>
      </div>
      <div className='flex flex-row justify-between pt-[18%] lg:pt-16'>
        <button
          onClick={onBack}
