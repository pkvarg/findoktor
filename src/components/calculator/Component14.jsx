...
const Component14 = ({ onBack, onNext, urbanQuality, handleUrbanQuality }) => {
  ...
  return (
    <div className='flex flex-col relative mx-4 lg:mx-[30%] -mt-[45%] md:-mt-[20%] lg:-mt-[12%]'>
      {' '}
      ...
      <div className='flex flex-row justify-center mt-4'>
        <div
          ...
          className='border-2 border-[#0076ba] pt-1 lg:pt-0 px-4  lg:px-2 rounded-[20px]  flex flex-col mx-1 lg:mx-3'
        >
      ...
      <div className='flex flex-row justify-center mt-4'>
        <div
          ...
          className='border-2 border-[#0076ba] px-2 rounded-[20px]  flex flex-col mx-1 lg:mx-3'
        >
      ...
      <div className='flex flex-row justify-between mx-[2%] mt-4 lg:mt-4'>
        <button
          onClick={onBack}
