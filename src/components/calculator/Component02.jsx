    ...
    <div className='flex flex-col mx-4 lg:mx-0'>
      ...
      <div className='flex flex-row justify-center gap-4 lg:gap-6 pt-2'>
        <div
          ...
          className='border-2 border-[#0076ba] px-2 py-2 rounded-[25px] lg:rounded-[35px] w-[110px] lg:w-[200px] h-[80px] lg:h-[140px] flex flex-col'
        >
          <div className='border-2 lg:border-4 border-[#0076ba] h-[15px] lg:h-[25px] w-[15px] lg:w-[25px] rounded-[30px] ml-[7.5px]'></div>
          <p className='text-[15px] lg:text-[25px] font-bold text-right pt-6 lg:mt-8 mr-2'>
            Garzónka
          </p>
        </div>
        <div
          ...
          className='border-2 border-[#0076ba] px-2 py-2 rounded-[25px] lg:rounded-[35px] w-[110px] lg:w-[200px] h-[80px] lg:h-[140px] flex flex-col relative'
        >
          ...
          <p className='absolute -top-0 right-4 text-[#0076ba] text-[40px] lg:text-[75px] font-bold text-right'>
            1
          </p>
          <p className='absolute text-[15px] lg:text-[25px] font-bold bottom-2 right-4'>
            izbový
          </p>
        </div>
      </div>
      ...
      <div className='flex flex-row justify-center gap-4 lg:gap-6 mt-2'>
        ...
        >
          ...
          <p className='absolute top-1 right-2 text-[#0076ba] text-[37.5px] lg:text-[75px] font-bold text-right'>
            5+
          </p>
