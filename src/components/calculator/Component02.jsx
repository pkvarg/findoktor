...
const Component02 = ({ onBack, onNext, handleCountRoomClick }) => {
  return (
    <div className='flex flex-col mx-1 lg:mx-[33%] 2xl:mx-[37%]'>
      <p className='text-[#0076ba] text-center text-[18px] lg:text-[25px] pt-4 lg:pt-16'>
        OCENENIE NEHNUTEĽNOSTI ONLINE
      </p>
      <h1 className='text-[25px] lg:text-[25px] text-center font-bold py-1 lg:py-8 leading-[35px]'>
        Zvoľte počet izieb
      </h1>
      <div className='flex flex-row justify-center gap-2 lg:gap-10 mt-4'>
        <div
          ...
          className='border-2 border-[#0076ba] px-2 py-2 rounded-[35px] w-[230px] h-[150px] lg:h-[180px] flex flex-col lg:gap-[19%]'
        >
          <div className='border-4 border-[#0076ba] h-[25px] w-[25px] rounded-[60px] ml-[15px] '></div>
          <p className='font-bold text-right mt-16 mr-3'>Garzónka</p>
        </div>
        <div
          id='1'
          onClick={() => handleCountRoomClick(1)}
          className='border-2 border-[#0076ba] px-2 py-2 rounded-[35px] w-[230px] h-[150px] lg:h-[180px]'
        >
          <div className='border-4 border-[#0076ba] h-[25px] w-[25px] rounded-[60px] ml-[15px] bg-[#0076ba]'></div>
          <p className='text-[#0076ba] text-[75px] font-bold text-right -mt-6 lg:-mt-4 mr-2'>
            1
          </p>
          <p className='font-bold text-right mr-3 -mt-6 lg:-mt-1'>izbový</p>
        </div>
      </div>
      <div className='flex flex-row justify-center gap-2 lg:gap-10 mt-2'>
        <div
          id='2'
        ...
        >
          ...
          <p className='text-[#0076ba] text-[75px] font-bold text-right -mt-[36%] lg:-mt-[26%] mr-2'>
            2
          </p>
          <p className='font-bold text-right mr-3 -mt-5 lg:-mt-1'>izbový</p>
        </div>
        <div
          id='3'
      ...
      <div className='flex flex-row justify-center gap-2 lg:gap-10 mt-2'>
        ...
        >
          ...
          <p className='text-[#0076ba] text-[75px] font-bold text-right -mt-[40%] lg:-mt-[28%] mr-2'>
            4
          </p>
          <p className='font-bold text-right mr-3 -mt-5 lg:mt-3'>izbový</p>
        </div>
        <div
          id='5'
        ...
        >
          ...
          <p className='text-[#0076ba] text-[62.5px] lg:text-[75px] font-bold text-right -mt-[54%] lg:-mt-[48.5%] mr-2'>
            5+
          </p>
          <p className='font-bold text-right mr-3 -mt-4 lg:mt-3'>izbový</p>
        </div>
      </div>
