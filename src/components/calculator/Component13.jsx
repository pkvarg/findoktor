    ...
    <div className='flex flex-col relative w-[98%] lg:w-[100%] mx-1 lg:mx-0 mt-[20%] lg:mt-[10%]'>
        ...
        <div className='border border-[#0076ba] rounded-lg lg:rounded-xl mt-4 h-[50px] lg:h-[55px] w-[100%] flex flex-col relative'>
          ...
          <div className=''>
            <input
              ...
              className='text-[22.5px] lg:text-[25px] absolute top-[25%] lg:top-[27.5%] w-[50%] right-[27.5%] lg:right-[20%] lg:mr-1 text-right font-bold outline-none z-0'
            />
      ...
      {/* <div className='flex flex-row justify-center mt-0'>
        <div className='border border-[#0076ba] rounded-lg lg:rounded-xl mt-4 h-[50px] lg:h-[55px] w-[100%] flex flex-col relative'>
          <label
            htmlFor='text'
            className='text-[#0076ba] text-[12.5px] lg:text-[15px] ml-2 '
          >
            <span className='fixed'>Mesačné náklady</span>
          </label>
          <div className='z-10'>
            <input
              type='number'
              value={monthlyCosts}
              onChange={(e) => setMonthlyCosts(e.target.value)}
              className='text-[22.5px] lg:text-[25px] absolute top-[26%] lg:top-[28%] w-[35%] right-[20%]  mr-3 lg:mr-3 text-right font-bold outline-none '
            />
